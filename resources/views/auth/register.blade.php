...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('assets/dist/img/brand/favicon.png" type="image/png') }}">
    <!-- Fonts -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700">
    <!-- Icons -->
    <link rel="stylesheet" href="{{ asset('assets/dist/vendor/nucleo/css/nucleo.css" type="text/css') }}">
    <link rel="stylesheet"
        href="{{ asset('assets/dist/vendor/@fortawesome/fontawesome-free/css/all.min.css" type="text/css') }}">
    <!-- Argon CSS -->
                    ...
                    <div class="row">
                        <div class="col-6 collapse-brand">
                            <a href="dashboard.html">
                                <img src="{{ asset('assets/dist/img/brand/blue.png') }}">
                            </a>
                        </div>
                                ...
                                <form role="form">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group input-group-merge input-group-alternative">
                                            ...
                                            <input placeholder="Password Retype" type="password"
